...
There are 60,000 of images in total. Figure.\ref{fig:two} shows the samples of the images. I plotted 10 images for each class.Figure.\ref{fig:three} and Figure.4 shows the distribution of the data. For the training dataset, each class has 5000 images and for the test dataset, each class has 1000 images.
